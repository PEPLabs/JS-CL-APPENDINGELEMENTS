...
public class SeleniumTest {
    ...
    private File findHtmlFile() {
        String[] possibleHtmlPaths = {
            "src/main/AppendingElements.html",
            "AppendingElements.html",
            "src/test/resources/AppendingElements.html",
            "test-resources/AppendingElements.html",
            "src/main/resources/AppendingElements.html"
        };
